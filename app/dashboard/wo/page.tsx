...
function getDueDateStyle(dateStr: string | null, isCompleted: boolean): string {
  ...
  if (!date) return "";
  if (isPastDate(date)) return "bg-red-100 text-red-800 font-bold dark:bg-red-500/25 dark:text-red-300";
  if (isSameMonth(date)) return "bg-amber-100 text-amber-800 font-bold dark:bg-amber-400/20 dark:text-amber-200";
  return "";
}
