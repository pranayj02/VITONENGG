  ...
  return (
    <div className="p-6 lg:p-8 max-w-5xl mx-auto">
      ...
      {showUpdatedToast && (
        <div className="mb-4 bg-green-50 border border-green-200 dark:bg-green-500/10 dark:border-green-500/30 rounded-xl p-3 text-green-700 dark:text-green-300 text-sm flex items-center justify-between gap-3">
          ...
          <button
            ...
            className="text-green-700 dark:text-green-200 hover:text-black dark:hover:text-white"
          >
            <X size={14} />
          </button>
        </div>
      ...
      {confirmId && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-900 border border-[#dde1ea] dark:border-gray-800 rounded-2xl w-full max-w-sm p-6">
            ...
            <h3 className="text-viton-navy dark:text-white font-bold text-center text-lg mb-1">Delete PO?</h3>
      ...
      <div className="mb-6">
        ...
        <p className="text-[#8892a8] dark:text-gray-500 text-sm mt-1">{pos.length} purchase orders total</p>
      </div>
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-3 ml-4 flex-shrink-0">
                    ...
                    <span className={`text-xs font-semibold px-2.5 py-1 rounded-lg capitalize ${statusColors[po.status] ?? "bg-[#f1f3f8] text-[#4a5578] dark:bg-gray-800 dark:text-gray-400"}`}>
                      {po.status}
                    </span>
                    {isOpen
                      ...
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="border-b border-[#dde1ea] dark:border-gray-800 bg-[#f7f8fb] dark:bg-gray-800/40">
                            ...
                            <th className="text-right text-[#8892a8] dark:text-gray-500 text-xs uppercase tracking-wider px-5 py-2.5">Total</th>
                          </tr>
                        </thead>
                        <tbody>
                          {lineItems.map((line, i) => (
                            <tr key={i} className="border-b border-[#eef1f6] dark:border-gray-800/40 last:border-0">
                              ...
                              <td className="px-5 py-2.5">
                                <p className="text-viton-navy dark:text-white text-sm">{line.name}</p>
                                {line.custom_note && (
                                  <p className="text-[#8892a8] dark:text-gray-500 text-xs mt-0.5 italic">↳ {line.custom_note}</p>
                                )}
                              </td>
                              <td className="px-5 py-2.5 text-[#4a5578] dark:text-gray-400">{line.quantity} {line.unit}</td>
                              <td className="px-5 py-2.5 text-right text-viton-navy dark:text-white font-medium">
                    ...
                    <div className="px-5 py-4 border-t border-[#dde1ea] dark:border-gray-800">
                      <div className="flex items-center justify-between flex-wrap gap-3">
                        <div>
                          ...
                          <span className="text-viton-navy dark:text-white font-bold">Rs. {po.total.toLocaleString("en-IN")}</span>
                          {po.notes && <p className="text-[#8892a8] dark:text-gray-500 text-xs mt-1">{po.notes}</p>}
                        </div>
